  ...
  try{
    ...
    var VERIFIED_FINANCIALS=(
      ...
      ?'\nNBFC/LENDING COMPANY — MANDATORY FIELDS (RBI + SEBI ICDR requirement):'
       ...
       +'\n  ROAA = Return on Average Assets — this is a RETURN metric NOT an asset quality metric. Label correctly.'
       +'\n  PORTFOLIO: Separate secured (gold/collateral-backed) vs unsecured lending. If unsecured >30% of book, update the investment thesis — the company is NOT a pure-play gold NBFC.'
    ...
    for(var mi=0;mi<activeModules.length;mi++){
      ...
      try{
        ...
        mtxt=mtxt.replace(/McKinsey\s*[&+]\s*KPMG[^\n]*/gi,'ipowork AI')
                 .replace(/KPMG IPO Advisory/gi,'ipowork AI')
                 .replace(/McKinsey & Company/gi,'ipowork AI')
                 .replace(/Goldman Sachs/gi,'ipowork AI')
                 .replace(/Morgan Stanley/gi,'ipowork AI')
                 .replace(/Prepared by: McKinsey[^\n]*/gi,'Prepared by: ipowork AI | Data: Probe42/MCA')
                 .replace(/Pre-IPO Advisory Report \| McKinsey[^\n]*/gi,'IPO Readiness Report | ipowork AI');
